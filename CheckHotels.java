...
public class CheckHotels extends JFrame implements Runnable{
    ...
    JLabel caption;
    public void run() {
        String[] text = new String[]{"JW Marriott Hotel", "Madarin Oirental Hotel", "Four SEasons Hotel", "Raddisson Blue Hotel", "Classio Hotel", "The Bay Club Hotel", "Breez Blow Hotel", "The Taj Hotel", "Happy Morning Hotel", "River View Hotel" };
        try{
            for(int i = 0; i <= 9; i++){
    ...
    CheckHotels() {
        ...
        caption = new JLabel();
        caption.setBounds(50, 500, 1000, 40);
