...
public class Dashboard extends JFrame implements ActionListener{
    ...
    String username;
    JButton addPersonalDetails, viewPersonalDetails, updatePersonalDetails, checkpackages, bookpackages, bookhotels;
    JButton viewpackages, viewhotels, destinations, viewBookedHotel, payments, calculator, notepad, about, deletePersonalDetails;
    Dashboard(String username){
        ...
        addPersonalDetails.setBounds(0, 0, 300, 65);
        ...
        checkpackages = new JButton("Ckeck Packages");
